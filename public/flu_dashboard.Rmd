...
vermont_zip_data <- read_rds("/home/brian/Desktop/flu/data/vermont_zip_data")
vermont_zip_geo <- read_rds("/home/brian/Desktop/flu/data/vermont_zip_geo")
```
...
```{r}
current_cases <- 11
valueBox(current_cases, caption = NULL, icon = "fa-diagnoses", color = ifelse(current_cases > 10, "red", "green"), href = NULL)
```
...
```{r}
current_cases <- 20
valueBox(current_cases, caption = NULL, icon = "fa-users", color = "blue", href = NULL)
```
...
Linked Census Map {data-navmenu="Census Data" data-icon="fa-map-marked"}
=====================================
...
htmltools::tags$iframe(
  ...
  seamless = "seamless",
  frameBorder = "0",
  style = "border:0; top:0; left:0; right:0; bottom:0; width:100%; height:calc(100vh - 80px) !important"
)
```
